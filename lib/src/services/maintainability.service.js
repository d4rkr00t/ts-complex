...
const { reduce, mergeWith, omitBy, isNull } = require("lodash");
...
exports.calculate = (filePath, target) => {
    ...
    return exports.calculateFromSource(filePath, sourceText, target);
};

exports.calculateFromSource = (filePath, sourceText, target) => {
